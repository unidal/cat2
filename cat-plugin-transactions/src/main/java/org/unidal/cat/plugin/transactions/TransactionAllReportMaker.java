...
public class TransactionAllReportMaker extends BaseVisitor {
   ...
   public TransactionAllReportMaker(TransactionReport report, ProjectService service, TransactionHelper helper,
         TransactionConfigProvider transactionConfigProvider) {
   ...
   public void visitName(TransactionName name) {
      ...
      if (validateName(m_currentType, nameId)) {
         ...
         DomainStat DomainStat = report.findOrCreateDistributionInType(trType.getId())
               .findOrCreateDistributionInName(nameId).findOrCreateBu(m_currentBu)
               .findOrCreateDomainStat(m_currentDomain);
   ...
   public void visitType(TransactionType type) {
      ...
      if (validateType(m_currentType)) {
         ...
         DomainStat domainStat = report.findOrCreateDistributionInType(m_currentType).findOrCreateBu(m_currentBu)
               .findOrCreateDomainStat(m_currentDomain);
