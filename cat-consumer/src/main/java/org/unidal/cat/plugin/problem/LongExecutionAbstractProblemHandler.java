...
@Named(type = ProblemHandler.class, value = LongExecutionAbstractProblemHandler.ID)
public class LongExecutionAbstractProblemHandler extends AbstractProblemHandler implements Initializable {
