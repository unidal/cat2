...
<jsp:useBean id="ctx" type="org.unidal.cat.plugin.event.page.Context" scope="request" />
<jsp:useBean id="payload" type="org.unidal.cat.plugin.event.page.Payload" scope="request" />
