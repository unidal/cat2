...
import org.unidal.cat.plugin.event.report.view.GraphPayload.FailurePayload;
import org.unidal.cat.plugin.event.report.view.GraphPayload.HitPayload;
...
public class GraphViewModel {
   ...
   public GraphViewModel(GraphBuilder builder, String ip, String type, String name, EventReport report) {
   ...
   public GraphViewModel(String ip, String type, String name, EventReport current, EventReport last,
         EventReport baseline) {
   ...
   private double[] aggregateMetrics(EventReport report, String ip, String type, String name, String metric, int size) {
   ...
   private void buildBarGraphs(GraphBuilder builder, EventReport report, String ip, String type, String name) {
   ...
   private void buildDistribution(EventReport report, String type, String name) {
   ...
   private LineChart buildLineChart(String ip, String type, String name, EventReport current, EventReport last,
         EventReport baseline, String metric) {
   ...
   private void buildLineCharts(String ip, String type, String name, EventReport current, EventReport last,
         EventReport baseline) {
   ...
   private void buildPieChart(EventReport report, String type, String name) {
