...
@Named(type = ReportReducer.class, value = EventConstants.NAME + ":" + EventWeeklyReducer.ID)
public class EventWeeklyReducer extends AbstractEventReducer implements ReportReducer<EventReport> {
