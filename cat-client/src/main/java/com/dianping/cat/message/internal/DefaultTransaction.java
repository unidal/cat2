...
import org.unidal.cat.message.tree.MessageTreeManager;
...
public class DefaultTransaction extends AbstractMessage implements Transaction {
   ...
   private MessageTreeManager m_manager;

   private boolean m_standalone;

   private long m_durationStart;

   public DefaultTransaction(String type, String name, MessageTreeManager manager) {
      super(type, name);
   ...
   protected MessageTreeManager getManager() {
      return m_manager;
   }
